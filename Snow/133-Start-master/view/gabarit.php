...
<head>
    ...
    <!-- Icons -->
    <link href="content/scripts/icons/general/stylesheets/general_foundicons.css" media="screen" rel="stylesheet" type="text/css" />
    <link href="content/scripts/icons/social/stylesheets/social_foundicons.css" media="screen" rel="stylesheet" type="text/css" />
    <!--[if lt IE 8]>
    ...
    <div class="divPanel notop nobottom">
            ...
            <div class="span12">
                ...
                <div class="camera_full_width">
                    <div id="camera_wrap">
                        <div data-src="slider-images/4.jpg" ><div class="camera_caption fadeFromBottom cap1">Les derniers modèles toujours à disposition.</div></div>
						<div data-src="slider-images/1.jpg" ><div class="camera_caption fadeFromBottom cap2">Découvrez des paysages fabuleux avec des sensations.</div></div>
        ...
        <div class="divPanel">
            ...
            <div class="row-fluid">
                ...
                <div class="span3" id="footerArea3">
                    ...
                    Vous pouvez aussi passer par le site. Pour le retrait et le dépot, vous devrez passer au guichet automatique à l'arrière du magasin
                    </p>
...
<script src="content/scripts/carousel/jquery.carouFredSel-6.2.0-packed.js" type="text/javascript"></script><script type="text/javascript">$('#list_photos').carouFredSel({ responsive: true, width: '100%', scroll: 2, items: {width: 320,visible: {min: 2, max: 6}} });</script><script src="content/scripts/camera/scripts/camera.min.js" type="text/javascript"></script>
